...
([Riess et al. 2008](https://arxiv.org/abs/2112.04510)), se observa que los valores obtenidos están por debajo del valor aceptado, aunque dentro de un rango razonable considerando las fuentes de error involucradas en el análisis.
